...
use wirekern::{valid_name, Client, Error, Site};
...
pub(crate) fn invalid_post(site: &str, reason: &str) -> wirekern::Error {
    wirekern::Error::InvalidPost {
        site: wirekern::Site::new(site),
        reason: reason.into(),
        limit: None,
    }
}
