...
impl Cli {
    ...
    /// normal `wirekern` process. Clap builds a broad command tree while
        ...
        T: Into<std::ffi::OsString> + Clone + Send + 'static,
    {
        std::thread::Builder::new()
            .name("wirekern-cli-parse-test".into())
    ...
    pub(crate) fn command() -> clap::Command {
        std::thread::Builder::new()
            .name("wirekern-cli-help-test".into())
            .stack_size(8 * 1024 * 1024)
