//! `wirekern media` — bounded first-page published-media reads.
use crate::ads::media_line;
use crate::app::fail;
use crate::output::{emit_raw, human_line};
use clap::Subcommand;
use wirekern::{AccountKey, Client, Deadline, MediaQuery, DEFAULT_MEDIA_LIMIT};
...
pub(crate) enum MediaCmd {
    ...
    List {
        site: String,
        /// First-page size, 1 through 25. Wirekern intentionally exposes no
