//! Local HTTP surface for wirekern. Same JSON as the CLI `--json` document.
//!
...
pub async fn run(home: &Path, bind: Option<&str>, json: bool) -> Result<(), Error> {
    ...
    if keys.list()?.is_empty() {
        eprintln!("create a key first: wirekern keys create --name <n>");
        return Err(Error::Auth {
            site: Site::new(""),
            reason: "no_keys".into(),
        });
    }
    // Same connector set as `wirekern post`. Deny-by-default client for
...
mod tests {
    ...
    impl Publisher for WaMock {
        ...
        async fn publish(
            &self,
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _intent: wirekern::Intent,
            _deadline: Deadline,
    ...
    fn test_router(tmp: &Path) -> (Router, String, Arc<WaMock>) {
        ...
        .unwrap();
        let ledger = Arc::new(wirekern::MemoryWhatsAppLedger::new());
        let deny =
    ...
    fn status_extras_flag_accepts_header_or_query() {
        ...
        headers.insert("x-wirekern-status-extras", "true".parse().unwrap());
        assert!(status_extras_requested(&headers, false));
    }
    ...
    #[async_trait]
    impl wirekern::InsightsSource for AdsReadMock {
        async fn insights(
            &self,
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _query: &wirekern::InsightsQuery,
            _deadline: Deadline,
        ) -> Result<wirekern::InsightsReply, Error> {
            Ok(wirekern::InsightsReply {
                site: self.site.clone(),
        ...
        async fn ad_accounts(
            ...
            _creds: &AccountCreds,
            _deadline: Deadline,
        ) -> Result<wirekern::AdAccountsReply, Error> {
            Ok(wirekern::AdAccountsReply {
                site: self.site.clone(),
                accounts: vec![wirekern::AdAccount {
                    id: "act_1".into(),
                    name: Some("Test".into()),
                    currency: None,
                    timezone: None,
    ...
    #[async_trait]
    impl wirekern::AdsManager for AdsReadMock {
        async fn create_paused_ad(
            &self,
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _request: &wirekern::CreatePausedAdRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::CreatedAd, Error> {
            Err(Error::UnsupportedCapability {
                site: self.site.clone(),
        ...
        async fn upload_ad_image(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _request: &wirekern::UploadAdImageRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::UploadedAdImage, Error> {
            Err(Error::UnsupportedCapability {
                site: self.site.clone(),
                need: Capability::CreatePausedAds,
            })
        ...
        async fn upload_ad_video(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _request: &wirekern::UploadAdVideoRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::UploadedAdVideo, Error> {
            Err(Error::UnsupportedCapability {
                site: self.site.clone(),
                need: Capability::CreatePausedAds,
            })
        ...
        async fn ad_video_status(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _request: &wirekern::AdVideoStatusRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::AdVideoStatus, Error> {
            Err(Error::UnsupportedCapability {
                site: self.site.clone(),
                need: Capability::CreatePausedAds,
            })
        ...
        async fn create_link_ad_creative(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _request: &wirekern::CreateLinkAdCreativeRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::CreatedAdCreative, Error> {
            Err(Error::UnsupportedCapability {
                site: self.site.clone(),
        ...
        async fn create_video_ad_creative(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _request: &wirekern::CreateVideoAdCreativeRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::CreatedAdCreative, Error> {
            Err(Error::UnsupportedCapability {
                site: self.site.clone(),
        ...
        async fn create_ad_creative(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            _request: &wirekern::CreateAdCreativeRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::CreatedAdCreative, Error> {
            Err(Error::UnsupportedCapability {
                site: self.site.clone(),
        ...
        async fn preview_ad_creative(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            request: &wirekern::CreativePreviewRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::CreativePreview, Error> {
            Ok(wirekern::CreativePreview {
                site: self.site.clone(),
        ...
        async fn ad_review_status(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            request: &wirekern::AdReviewStatusRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::AdReviewStatus, Error> {
            Ok(wirekern::AdReviewStatus {
                site: self.site.clone(),
        ...
        async fn list_ads_inventory(
            ...
            _app: &wirekern::AppConfig,
            _creds: &AccountCreds,
            request: &wirekern::AdsInventoryRequest,
            _deadline: Deadline,
        ) -> Result<wirekern::AdsInventoryReply, Error> {
            Ok(wirekern::AdsInventoryReply {
                site: self.site.clone(),
                account_id: "act_1".into(),
                kind: request.kind,
                items: vec![],
