...
```bash
wirekern ads list meta_ads --entity campaign --ad-account act_1414222080648203 --json
wirekern ads list meta_ads --entity adset --ad-account act_1414222080648203 --json
wirekern ads inspect meta_ads --entity campaign --id <id> --json
```
...
```bash
wirekern ads activate meta_ads --entity adset --id <id> --confirm-id <id> \
  --confirm-daily-budget <n> --allow-activate --state activate.state.json
wirekern ads pause meta_ads --entity adset --id <id>
```
