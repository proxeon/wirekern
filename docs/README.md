...
| [whatsapp-cloud/](./whatsapp-cloud/) | WhatsApp Cloud setup: System User token, explicit template/reply sends, and signed inbound webhook parsing. Remaining work: [checklist.md](./whatsapp-cloud/checklist.md). |
